...
public class CeIISAInstructionDIV extends CeIISAInstruction {
   public CeIISAInstructionDIV(String mnemonic) {
      super(mnemonic);
   }
   ...
   protected void execute(ArrayList<Integer> params, CeIVMAPIMemory mem, CeIVMAPISpecialRegs regs, CeIVMAPIIOSubSys io) throws CeIVMMemoryException, CeIVMRuntimeException {
      ...
      if (divisor == 0) {
         throw new CeIVMRuntimeException("División por cero en DIV.", regs.getPc());
      } else {
