...
public class CeIISAInstructionIPRINT extends CeIISAInstruction {
   public CeIISAInstructionIPRINT(String mnemonic) {
      super(mnemonic);
   }
   ...
   protected void execute(ArrayList<Integer> params, CeIVMAPIMemory mem, CeIVMAPISpecialRegs regs, CeIVMAPIIOSubSys io) throws CeIVMMemoryException, CeIVMRuntimeException {
      io.getOutputStream().print(mem.read(regs.getSp()));
